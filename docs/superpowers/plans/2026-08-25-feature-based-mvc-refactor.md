...
- [x] **Step 1: Add a failing route-composition test**
...
- [x] **Step 2: Run the focused tests and confirm the missing root router fails**
...
- [x] **Step 3: Move authentication middleware**
...
- [x] **Step 4: Extract error middleware and health routing**
...
- [x] **Step 5: Compose routes and simplify the app**
...
- [x] **Step 1: Add failing controller-boundary tests**
...
- [x] **Step 2: Run the boundary test and confirm current routes fail it**
...
- [x] **Step 3: Extract auth controllers**
...
- [x] **Step 4: Rename the auth repository and colocate password operations**
...
- [x] **Step 5: Extract users schemas and controllers**
...
- [x] **Step 6: Rename the users repository**
...
- [x] **Step 1: Extend the boundary test for ticketing**
...
- [x] **Step 2: Run the boundary test and confirm ticketing fails it**
...
- [x] **Step 3: Extract ticketing controllers**
...
- [x] **Step 4: Add the ticketing model boundary**
...
- [x] **Step 5: Rename ticketing authorization**
...
- [x] **Step 1: Update the README architecture section**
...
- [x] **Step 3: Check the migration is complete**
